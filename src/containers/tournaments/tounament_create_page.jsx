            ...
            <Card style={{margin: '12px'}}>
                <Card.Body>
                    <Form onSubmit={this.onSubmit}>
                        ...
                        <Form.Group as={Row}>
                            <Form.Label as="legend" column sm={3}>Условие завершения матча</Form.Label>
                            <Col sm={2}>
                                <Form.Control type="number" name="numToWin" onChange={this.onChangeInput}
                                              />
                            </Col>
                            <Col sm={3}>
                                побед (голов, очков и т.д.)
                            </Col>
                        </Form.Group>

                        <Form.Group>
                            <Form.Label>Даты проведения</Form.Label>
                            <Row>
                                <Col sm={1}>
                                    c
                                </Col>
                                <Col sm={3}>
                                    <Form.Control type="date" name="dateStart" onChange={this.onChangeInput}
                                                  />
                                </Col>
                                <Col sm={1}>
                                    до
                                ...
                                <Col sm={3}>
                                    <Form.Control type="date" name="dateFinish" onChange={this.onChangeInput}
                                                  />
                                </Col>
                            </Row>
                        </Form.Group>
